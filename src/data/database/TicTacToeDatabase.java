...
public class TicTacToeDatabase {
    ...
    private TicTacToeDatabase() throws SQLException {
        ...
        try {
            connection = DriverManager.getConnection("jdbc:derby:client_tic_tac_toe_db;ifexists=true", "root", "root");
        } catch (SQLException e) {
            connection = DriverManager.getConnection("jdbc:derby:client_tic_tac_toe_db;create=true", "root", "root");
            initDababase();
        }
